									...
									<form method="post" action="insert_update.php">
										...
										<div class="row mt-4">
											<div class="col-md-4">
												...
												<input id="inputFirstname" class="form-control" type="text" name="firstname" placeholder="Ism" value="<?= $result['first_Name'] ?>">
											</div>
											<div class="col-md-4">
												<label for="inputLastname">Familya</label>
												<input id="inputLastname" class="form-control" type="text" name="lastname" placeholder="Familya" value="<?= $result['last_Name'] ?>">
											</div>
											<div class="col-md-4">
												<label for="inputPhone">Telefon</label>
												<input id="inputPhone" class="form-control" type="text" name="phone" placeholder="Telefon" value="<?= $result['phone'] ?>">
											</div>
										</div>
										<div class="row mt-4">
											<div class="col-md-6">
